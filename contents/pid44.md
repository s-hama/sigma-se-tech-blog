## タイトル
応用情報技術 - 離散数学：基数変換・補数・誤差の整理

## 概要
応用情報技術者試験で出題される**離散数学**のうち、基数変換、補数表現、小数表現、数値誤差、集合演算を整理する。

離散数学は、計算機が数値や論理をどのように扱うかを理解するための土台となる。<br>
特に、\\(2\\) 進数、補数、浮動小数点数の誤差は、試験だけでなくプログラムの挙動を理解するうえでも重要となる。
...
- 小数表現の正規化<br>
    ...
    - 例 \\(1\\) : \\((0.00052)_{10}\\) を正規化する。
        ...
        このような表し方もできるため、試験では「仮数部をどの範囲に収めるか」という条件を確認する必要がある。
...
応用情報技術者試験では、集合記号と論理演算の対応を問われることがある。
