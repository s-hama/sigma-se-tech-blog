...
## この記事の構成
- [イミュータブル（immutable）: 同一アドレスで変更不可](#イミュータブルimmutable--同一アドレスで変更不可)<br>
  イミュータブル（immutable）: 同一アドレスで変更不可の手順と確認ポイントを整理。
- [ミュータブル（mutable）: 同一アドレスで変更可](#ミュータブルmutable--同一アドレスで変更可)<br>
  ミュータブル（mutable）: 同一アドレスで変更可の手順と確認ポイントを整理。
