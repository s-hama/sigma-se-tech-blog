...
| 確認項目 | 内容 |
| --- | --- |
| 数値微分 | 前の記事の中心差分による数値微分を確認しておく。 |
| NumPy | 配列のコピー、要素更新、nditerの扱いを確認しておく。 |
| 数学 | 2変数関数とグラフの傾きのイメージを持っておく。 |
...
## 実務とのつながり
- パラメータ更新の基礎<br>
    大量の重みに対して損失の変化を調べる考え方は、ニューラルネットワークの学習そのものにつながる。
- 実装デバッグ<br>
    勾配のshapeや値の大きさを確認すると、学習が進まない原因を探しやすい。
