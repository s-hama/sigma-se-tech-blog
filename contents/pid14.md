...
- 黄金比
  - 表示
    <div style="margin-left: 3rem; font-size: 2em;">
      <math>
        <mfrac>
          <mrow>
...
- 極限値
  - 表示
    <div style="margin-left: 3rem; font-size: 1.75em;">
      <math>
        <munder>
          <mi>lim</mi>
          <mrow>
...
- 逆行列
  - 表示
    <div style="margin-left: 3rem; font-size: 1.5em;">
      <math>
        <mtable>
          <mtr>
            <mtd>
...
- 二次方程式の解
  - 表示 
    <div style="display: flex; margin-left: 3rem; font-size: 1.5em;">
    \[
